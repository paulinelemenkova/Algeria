...
\Title{Ephemeral Salt Lakes Melrhir Chott and Merouane Chott, Algeria: Changes in Patterns Over a 10-year Period}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Ephemeral Salt Lakes Melrhir Chott and Merouane Chott, Algeria: Changes in Patterns Over a 10-year Period}
...
In this paper, we identify the variations in the ephemeral salt lakes in the Algerian part of Sahara on 10-year period (2013-2023) using the series of the Landsat OLI/TIRS multispectral images by GRASS GIS. 

\begin{figure}[H]
\begin{adjustwidth}{-\extralength}{0cm}
\centering
		\hspace{-30pt}\includegraphics[width=17.0 cm]{Fig_01.jpg}
\end{adjustwidth}
