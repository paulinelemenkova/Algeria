...
\caption{(\textbf{a}): Enlarged fragment of the Melrhir Chott and Merouane Chott on the Google Maps (2023); (\textbf{b}): Melrhir Chott and Merouane Chott on the Google Earth aerial scene (2023)}\label{fig02}
\end{figure}
...
\subsection{General process flowchart}
