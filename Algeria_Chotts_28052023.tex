...
Soil of northern Sahara \hl{lacks} organic carbon, which affects their agricultural and vegetation potential and results in \hl{a} specific type\hl{ }of flora adopted to a highly depleted dry soil of the semi-arid climate \cite{BOUBEHZIZ2020104539}. While the most areas of chotts are devoid of vegetation due to high salt concentrations in soil, there are\hl{ }occasional\hl{ }types distributed over the moist areas and edges of\hl{ }wetlands. \hl{Such} plants are mainly composed of halophytic, succulent and perennial species\hl{, e.g.,} \emph{Chenopodiaceae} family adapted to droughts and salty soils \cite{KHAZNADAR2009369}.

The geologic structures in sedimentary basins of the Sahara include large and deep reservoirs \hl{contoured} by chotts\hl{ }filled by water during\hl{ }rainy periods \cite{HAMICHE2015261}. The salt pans of \hl{the }Chott Merouane and Melrhir\hl{ }present examples of sensitive wetlands in an arid climate \hl{of Algeria}. Social benefits and the effects from such unique landscapes include \hl{three} types of benefits: 1) salt mining in the pan; 2) palm inter cropping and palm monoculture; 3) grazing areas in a palm oasis on the border of the lake \cite{Demnati2012}. Despite the ecological importance, geochemical special setting, unique landscapes of the saline lakes, and the specific biodiversity, the studies on the Algerian Chotts remain scarce and relatively few. In view of this, current study presents a contribution to the investigation of the Algerian Chotts through satellite image processing. 
