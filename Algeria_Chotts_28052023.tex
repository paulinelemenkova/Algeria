...
The GRASS GIS-based image classification workflow is based on a Landsat 8-9 dataset containing nine satellite images (Figure \ref{fig03}) covering the region of Chott Melrhir and Chott Merouane, Algeria. The major metadata are listed in Table \ref{tab1}. 
...
The remote sensing data were \hl{processed} by scripting methods, Figure \ref{fig04}.  
