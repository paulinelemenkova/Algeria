...
\Title{Monitoring Basins of the Ephemeral Salt Lakes Melrhir Chott and Merouane Chott, Algeria by Landsat 8-9 Satellite Images}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Monitoring Basins of the Ephemeral Salt Lakes Melrhir Chott and Merouane Chott, Algeria by Landsat 8-9 Satellite Images}
...
\makebox[0.90\linewidth][r]{%
	...
	\begin{subfigure}[b]{.40\textwidth}
		...
		\caption{2023}
	\end{subfigure}%
}\caption{Landsat 8-9 OLI/TIRS images in natural colour RGB values showing for nine consecutive years (January): (\textbf{a}) 2014/01/01, (\textbf{b}) 2015/01/04, (\textbf{c}) 2016/01/07, (\textbf{d}) 2018/01/28, (\textbf{e}) 2019/01/15, (\textbf{f}) 2020/01/02, (\textbf{g}) 2021/01/04, (\textbf{h}) 2022/01/15, (\textbf{i}) 2023/01/10.}\label{fig:03}
\end{figure}
